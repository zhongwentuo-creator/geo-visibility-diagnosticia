...
>
> **Current status**: V1.0 nine-stage engine is frozen; V1.5 is live on Render. The first production diagnosis produced JSON/HTML reports, while complete SSE acceptance is pending a corrective deployment and retest.

[中文版本](README.zh.md) | [V1.5 Web README](v1.5/README.md) | [Node 4 execution](v1.5/docs/NODE4_EXECUTION.md) | [V1.5 delivery plan](v1.5/docs/plan.md) | [V1.5 node records](v1.5/docs/PROJECT_NODE_RECORDS.md) | [VibeCoding acceptance matrix](docs/VIBECODING_ACCEPTANCE_MATRIX.md)
...
| V1.5 node 4 execution | `v1.5/docs/NODE4_EXECUTION.md` | Current action, evidence-reading order and cross-dialogue handoff for the production diagnosis gate. |
| V1.5 release evidence | `v1.5/docs/plan.md`, `v1.5/docs/ACCEPTANCE.md`, `v1.5/docs/PROJECT_NODE_RECORDS.md` | Render and production configuration are complete. The first real-brand run passed JSON/HTML but not complete SSE; cross-device and 24-hour retests remain pending. |
| Project governance | `AGENTS.md`, `MEMORY.md`, `docs/VIBECODING_ACCEPTANCE_MATRIX.md` | Rules, stable decisions and V1.5 traceability. |
